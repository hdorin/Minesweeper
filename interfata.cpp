...
void DisplayVictoryMessage(){
    int sy=(NoC/2)*40-164,sx=(NoL/2)*40-80;
    setcolor(WHITE);
...
void DisplayMenu_Options(){
    ...
    setcolor(WHITE);
    settextstyle(BOLD_FONT,   HORIZ_DIR, 4);
    outtextxy(dmo.sx+10,dmo.sy+5+dmo.addy+dmo.addby,"Medium 14x16");
    ...
    setcolor(WHITE);
    settextstyle(BOLD_FONT,   HORIZ_DIR, 4);
    outtextxy(dmo.sx+10+dmo.addx+dmo.addbx,dmo.sy+5,"Hard 14x24");
    ...
    setcolor(WHITE);
    settextstyle(BOLD_FONT,   HORIZ_DIR, 3);
    outtextxy(dmo.sx+10+dmo.addx+dmo.addbx,dmo.sy+35+dmo.addy+dmo.addby,"Bombs: 80");
